...
<!--    </div>-->
    <div class="data-table-container margin-bottom-1">
      <i-table class="data-table"
        ...
        <table-column min-width="120" prop="logo" :label="$t('app.application.certification.logo')">
          <template slot-scope="scope">
            <img height="32" :src="scope.row.logo|filePath">
          </template>
        </table-column>
        <table-column min-width="120" prop="license" :label="$t('app.application.certification.license')">
          <template slot-scope="scope">
            <img height="32" :src="scope.row.license|filePath">
          </template>
        </table-column>
        <table-column
          width="190"
