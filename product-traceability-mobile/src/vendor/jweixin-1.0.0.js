...
return { timeStamp: a.timestamp + '', nonceStr: a.nonceStr, 'package': a.package, paySign: a.paySign, signType: a.signType || 'SHA1' };
 ...
 var d, e, f; switch (delete b.err_code, delete b.err_desc, delete b.err_detail, d = b.errMsg, d || (d = b.err_msg, delete b.err_msg, d = h(a, d), b.errMsg = d), c = c || {}, c._complete && (c._complete(b), delete c._complete), d = b.errMsg || '', E.debug && !c.isInnerInvoke && alert(JSON.stringify(b)), e = d.indexOf(':'), f = d.substring(e + 1)) {
 case 'ok':c.success && c.success(b); break; case 'cancel':c.cancel && c.cancel(b); break; default:c.fail && c.fail(b);
}c.complete && c.complete(b);
} function h (a, b) {
var e, f, c = a, d = p[c]; return d && (c = d), e = 'ok', b && (f = b.indexOf(':'), e = b.substring(f + 1), e == 'confirm' && (e = 'ok'), e == 'failed' && (e = 'fail'), e.indexOf('failed_') != -1 && (e = e.substring(7)), e.indexOf('fail_') != -1 && (e = e.substring(5)), e = e.replace(/_/g, ' '), e = e.toLowerCase(), (e == 'access denied' || e == 'no permission to execute') && (e = 'permission denied'), c == 'config' && e == 'function not exist' && (e = 'ok'), e == '' && (e = 'fail')), b = c + ':' + e;
} function i (a) {
var b, c, d, e; if (a) {
...
var c = p[a]; c && (a = c), b && b._complete && delete b._complete, console.log('"' + a + '",', b || '');
 ...
 D.preVerifyState != 0 && (u || v || E.debug || z < '6.0.2' || D.systemType < 0 || A || (A = !0, D.appId = E.appId, D.initTime = C.initEndTime - C.initStartTime, D.preVerifyTime = C.preVerifyEndTime - C.preVerifyStartTime, H.getNetworkType({ isInnerInvoke: !0,
success: function (a) {
...
a.WeixinJSBridge && WeixinJSBridge.on(b, c);
...
} var o, p, q, r, s, t, u, v, w, x, y, z, A, B, C, D, E, F, G, H; if (!a.jWeixin) {
 ...
 var b, a = {}; for (b in o)a[o[b]] = b; return a;
...
checkJsApi: function (a) {
 var b = function (a) {
var c, d, b = a.checkResult; for (c in b)d = p[c], d && (b[d] = b[c], delete b[c]); return a;
...
getNetworkType: function (a) {
 var b = function (a) {
var c, d, e, b = a.errMsg; if (a.errMsg = 'getNetworkType:ok', c = a.subtype, delete a.subtype, c)a.networkType = c; else {
...
addCard: function (a) {
var e, f, g, h, b = a.cardList, d = []; for (e = 0, f = b.length; f > e; ++e)g = b[e], h = { card_id: g.cardId, card_ext: g.cardExt }, d.push(h); c(o.addCard, { card_list: d }, (function () {
return a._complete = function (a) {
var c, d, e, b = a.card_list; if (b) {
...
openCard: function (a) {
 var e, f, g, h, b = a.cardList, d = []; for (e = 0, f = b.length; f > e; ++e)g = b[e], h = { card_id: g.cardId, code: g.code }, d.push(h); c(o.openCard, { card_list: d }, a);
},
